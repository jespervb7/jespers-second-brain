# Dumpfilters - Add all columns to a measure to show filters
...
Credit goes out to Tabular Editor, on their blog they have a article with some useful C# scripts. Check it out [here](https://docs.tabulareditor.com/te2/Useful-script-snippets.html)

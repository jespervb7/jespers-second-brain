# UI friendly perspective editor

The script below generates a nice and easy way to edit perspectives using [Tabular Editor 2.](../../knowledge/Tabular Editor 2.md) Tabular Editor 3 has an inbuild editor to use so if your organisation has a Tabular Editor 3 license it's not needed.

## Sample images
![](../../assets/Script perspective editor/TA starting point.png)
![](../../assets/Script perspective editor/TA editing perspective.png)

## Script
```C# title="C# script that creates a friendly UI to edit perspectives in" linenums="1"
#r "System.Drawing"
